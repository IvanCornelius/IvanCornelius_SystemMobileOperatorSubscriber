...
MobileSub::MobileSub(unsigned long long inpPhoneNumber, double inpIncomingTime, double inpOutgoingTime, QString *TextError)
{
...
bool MobileSub::setTypeSubscriber(QString inpType)
{
...
QString MobileSub::getTypeSubscriber()
{
...
void MobileSub::setSpecParam(int com, QString value) {}


//получить специфический параметр
QString MobileSub::getSpecParam(int com)
{
...
bool MobileSub::inp(unsigned long long inpPhoneNumber, double inpIncomingTime, double inpOutgoingTime, QString *outTextError)
{
    QString TextError;
...
bool MobileSub::inp(QTextStream *file, QString *outTextError)
{
    try
    {
...
QString MobileSub::getTextOut()
{
    return "Номер телефона: " + QString::number(getPhoneNumber()) + "\n"
         + "Тип абонента: " + getTypeSubscriber() + "\n"
         + "Время входящих звонков: " + QString::number(getIncomingTime()) + "\n"
         + "Время исходящих звонков: " + QString::number(getOutgoingTime()) + "\n";
}


//вывод информации (способ 2)
bool MobileSub::out(QTextStream *file)
{
    try
    {
